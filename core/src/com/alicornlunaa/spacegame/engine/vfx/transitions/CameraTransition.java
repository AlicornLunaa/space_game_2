...
public class CameraTransition implements IVfx {
    ...
    // Constructor
    public CameraTransition(Stage stage, OrthographicCamera startingCam, OrthographicCamera endingCam, float time){
        this.stage = stage;
    ...
    public boolean update(float delta){
        ...
        transitionCam.zoom = ((1 - scalar) * startingCam.zoom) + (scalar * endingCam.zoom);
        transitionCam.zoom = 500;
        transitionCam.update();
