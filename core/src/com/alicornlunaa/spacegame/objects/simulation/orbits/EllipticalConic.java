...
public class EllipticalConic extends GenericConic {
    ...
    public EllipticalConic(Celestial parent, BaseEntity child, Vector2 position, Vector2 velocity) { super(parent, child, position, velocity); }
    public EllipticalConic(Celestial parent, BaseEntity child) { super(parent, child); }
